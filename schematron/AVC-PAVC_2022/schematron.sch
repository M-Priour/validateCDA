...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Scenario: PAVC -  (1.2.250.1.213.1.1.1.44.4.2)</title>
   ...
   <!-- Include the project schematrons related to scenario PAVC -->
   <!-- AVC-PAVC -->
   <pattern>
      <title>AVC-PAVC</title>
      <rule context="/">
         <assert role="warning" test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.25'][@extension = '2022.01']]" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--ASIP-AVC-PAVC-?id=1.2.250.1.213.1.1.1.25">descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.25'][@extension = '2022.01']]: Instance is expected to have the following element: %%2</assert>
      </rule>
   </pattern>
   <include href="include/1.2.250.1.213.1.1.1.25-2020-08-05T132441.sch"/>
   <include href="include/1.2.250.1.213.1.1.1.25-2020-08-05T132441-closed.sch"/>
