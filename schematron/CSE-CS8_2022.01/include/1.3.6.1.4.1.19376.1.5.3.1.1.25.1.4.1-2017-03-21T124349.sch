...
Item: (IHEPatientTransfer)
-->
    <rule fpi="RULC-1" context="*[hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]]/hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]" id="d141e9583-false-d300051e0">
...
Item: (IHEPatientTransfer)
-->
    <rule fpi="RULC-1" context="*[hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]]/hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]/hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']" id="d141e9586-false-d300115e0">
        <extends rule="II"/>
...
Item: (IHEPatientTransfer)
-->
    <rule fpi="RULC-1" context="*[hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]]/hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]/hl7:id" id="d141e9588-false-d300128e0">
        <extends rule="II"/>
        <assert role="error" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--CSE-CS8-?id=1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1" test="empty(@xsi:type) or resolve-QName(@xsi:type, .) = QName('urn:hl7-org:v3', 'II')">(IHEPatientTransfer): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
    </rule>
   <!--
...
Item: (IHEPatientTransfer)
-->
    <rule fpi="RULC-1" context="*[hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]]/hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]/hl7:code[(@code = '107724000' and @codeSystem = '2.16.840.1.113883.6.96')]" id="d141e9589-false-d300138e0">
        <extends rule="CD"/>
...
Item: (IHEPatientTransfer)
-->
    <rule fpi="RULC-1" context="*[hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]]/hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]/hl7:text" id="d141e9591-false-d300153e0">
        <extends rule="ED"/>
...
Item: (IHEPatientTransfer)
-->
    <rule fpi="RULC-1" context="*[hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]]/hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]/hl7:text/hl7:reference[not(@nullFlavor)]" id="d141e9592-false-d300171e0">
        <extends rule="TEL"/>
...
Item: (IHEPatientTransfer)
-->
    <rule fpi="RULC-1" context="*[hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]]/hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]/hl7:statusCode[not(@nullFlavor)]" id="d141e9593-false-d300180e0">
        <extends rule="CS"/>
...
Item: (IHEPatientTransfer)
-->
    <rule fpi="RULC-1" context="*[hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]]/hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]/hl7:effectiveTime" id="d141e9594-false-d300189e0">
        <extends rule="IVL_TS"/>
...
Item: (IHEPatientTransfer)
-->
    <rule fpi="RULC-1" context="*[hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]]/hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]/hl7:effectiveTime/hl7:high" id="d141e9595-false-d300211e0">
...
Item: (IHEPatientTransfer)
-->
    <rule fpi="RULC-1" context="*[hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]]/hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]/hl7:effectiveTime/hl7:low" id="d141e9596-false-d300220e0">
        <extends rule="IVXB_TS"/>
        <assert role="error" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--CSE-CS8-?id=1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1" test="empty(@xsi:type) or resolve-QName(@xsi:type, .) = QName('urn:hl7-org:v3', 'IVXB_TS')">(IHEPatientTransfer): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:IVXB_TS". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
    </rule>
   <!--
...
Item: (IHEPatientTransfer)
-->
    <rule fpi="RULC-1" context="*[hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]]/hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]/hl7:participant[@typeCode = 'DST']" id="d141e9597-false-d300229e0">
...
Item: (IHEPatientTransfer)
-->
    <rule fpi="RULC-1" context="*[hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]]/hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]/hl7:participant[@typeCode = 'DST']/hl7:templateId" id="d141e9599-false-d300250e0">
...
Item: (IHEPatientTransfer)
-->
    <rule fpi="RULC-1" context="*[hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]]/hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]/hl7:participant[@typeCode = 'DST']/hl7:participantRole[hl7:code]" id="d141e9601-false-d300260e0">
...
Item: (IHEPatientTransfer)
-->
    <rule fpi="RULC-1" context="*[hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]]/hl7:act[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.25.1.4.1']]/hl7:participant[@typeCode = 'DST']/hl7:participantRole[hl7:code]/hl7:playingEntity[hl7:name]" id="d141e9607-false-d300325e0">
