...
Description: The general appearance section shall contain a description of the overall, visibly-apparent condition of the patient
-->
...
Item: (IHEGeneralAppearanceSection)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.16']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.16']]" id="d141e9792-false-d302449e0">
...
Item: (IHEGeneralAppearanceSection)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.16']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.16']]/hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.16']" id="d141e9793-false-d302504e0">
        <extends rule="II"/>
...
Item: (IHEGeneralAppearanceSection)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.16']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.16']]/hl7:id[not(@nullFlavor)]" id="d141e9795-false-d302517e0">
        <extends rule="II"/>
        <assert role="error" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--CSE-CS8-?id=1.3.6.1.4.1.19376.1.5.3.1.1.9.16" test="empty(@xsi:type) or resolve-QName(@xsi:type, .) = QName('urn:hl7-org:v3', 'II')">(IHEGeneralAppearanceSection): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
    </rule>
   <!--
...
Item: (IHEGeneralAppearanceSection)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.16']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.16']]/hl7:code[(@code = '10210-3' and @codeSystem = '2.16.840.1.113883.6.1')]" id="d141e9796-false-d302527e0">
        <extends rule="CE"/>
...
Item: (IHEGeneralAppearanceSection)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.16']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.16']]/hl7:text[not(@nullFlavor)]" id="d141e9798-false-d302542e0">
