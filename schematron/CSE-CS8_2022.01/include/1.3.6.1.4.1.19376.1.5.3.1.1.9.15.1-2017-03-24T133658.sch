...
Item: (IHECodedDetailedPhysicalExaminationSection)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15']]" id="d152e57699-false-d347561e0">
...
Item: (IHECodedDetailedPhysicalExaminationSection)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15']]/hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15.1']" id="d152e57701-false-d347997e0">
      <extends rule="II"/>
...
Item: (IHECodedDetailedPhysicalExaminationSection)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15']]/hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15']" id="d152e57706-false-d348015e0">
      <extends rule="II"/>
      <assert role="error" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--CSE-CS8-?id=1.3.6.1.4.1.19376.1.5.3.1.1.9.15.1" test="empty(@xsi:type) or resolve-QName(@xsi:type, .) = QName('urn:hl7-org:v3', 'II')">(IHECodedDetailedPhysicalExaminationSection): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
...
Item: (IHECodedDetailedPhysicalExaminationSection)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15']]/hl7:id" id="d152e57711-false-d348033e0">
      <extends rule="II"/>
      <assert role="error" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--CSE-CS8-?id=1.3.6.1.4.1.19376.1.5.3.1.1.9.15.1" test="empty(@xsi:type) or resolve-QName(@xsi:type, .) = QName('urn:hl7-org:v3', 'II')">(IHECodedDetailedPhysicalExaminationSection): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
   </rule>
   <!--
...
Item: (IHECodedDetailedPhysicalExaminationSection)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.15']]/hl7:text" id="d152e57718-false-d348064e0">
