...
Item: (IHEVisibleImplantedMedicalDevicesSection)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.48']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.48']]" id="d152e59034-false-d353251e0">
...
Item: (IHEVisibleImplantedMedicalDevicesSection)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.48']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.48']]/hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.48']" id="d152e59036-false-d353331e0">
      <extends rule="II"/>
...
Item: (IHEVisibleImplantedMedicalDevicesSection)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.48']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.48']]/hl7:id[not(@nullFlavor)]" id="d152e59041-false-d353349e0">
      <extends rule="II"/>
      <assert role="error" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--CSE-CS8-?id=1.3.6.1.4.1.19376.1.5.3.1.1.9.48" test="empty(@xsi:type) or resolve-QName(@xsi:type, .) = QName('urn:hl7-org:v3', 'II')">(IHEVisibleImplantedMedicalDevicesSection): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
   </rule>
   <!--
...
Item: (IHEVisibleImplantedMedicalDevicesSection)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.48']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.48']]/hl7:code[(@code = 'XX-VisibleImplantedDevices' and @codeSystem = '2.16.840.1.113883.6.1')]" id="d152e59043-false-d353361e0">
      <extends rule="CE"/>
...
Item: (IHEVisibleImplantedMedicalDevicesSection)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.48']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.9.48']]/hl7:text[not(@nullFlavor)]" id="d152e59048-false-d353380e0">
