...
Item: (IHEExtremitiesSection)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.16.2.1']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.16.2.1']]" id="d152e57147-false-d345458e0">
...
Item: (IHEExtremitiesSection)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.16.2.1']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.16.2.1']]/hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.16.2.1']" id="d152e57149-false-d345538e0">
      <extends rule="II"/>
...
Item: (IHEExtremitiesSection)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.16.2.1']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.16.2.1']]/hl7:id[not(@nullFlavor)]" id="d152e57154-false-d345556e0">
      <extends rule="II"/>
      <assert role="error" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--CSE-CS8-?id=1.3.6.1.4.1.19376.1.5.3.1.1.16.2.1" test="empty(@xsi:type) or resolve-QName(@xsi:type, .) = QName('urn:hl7-org:v3', 'II')">(IHEExtremitiesSection): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
   </rule>
   <!--
...
Item: (IHEExtremitiesSection)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.16.2.1']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.16.2.1']]/hl7:code[(@code = '10196-4' and @codeSystem = '2.16.840.1.113883.6.1')]" id="d152e57156-false-d345568e0">
      <extends rule="CE"/>
...
Item: (IHEExtremitiesSection)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.16.2.1']]]/hl7:section[hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.16.2.1']]/hl7:text[not(@nullFlavor)]" id="d152e57161-false-d345587e0">
