...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" queryBinding="xslt2">
    <title>Scenario: V1 - Initial (1.2.250.1.213.1.1.1.5.1.4.2)</title>
...
<!-- CSE-CS8_2022.01 -->
    <pattern>
        <title>CSE-CS8_2022.01</title>
        <rule context="/">
            <assert role="warning" test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.5'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.5.1']]" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--CSE-CS8-?id=1.2.250.1.213.1.1.1.5.1">descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.5'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.5.1']]: Instance is expected to have the following element: %%2</assert>
        </rule>
    </pattern>
    <include href="include/1.2.250.1.213.1.1.1.5.1-2020-07-06T100844.sch"/>
    <include href="include/1.2.250.1.213.1.1.1.5.1-2020-07-06T100844-closed.sch"/>
