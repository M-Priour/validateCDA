...
Item: (FR-DICOM-Demande-examen)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.211'] and hl7:templateId[@root = '1.2.840.10008.9.7']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.211'] and hl7:templateId[@root = '1.2.840.10008.9.7']]" id="d823743e3056-false-d898143e0">
...
Item: (FR-DICOM-Demande-examen)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.211'] and hl7:templateId[@root = '1.2.840.10008.9.7']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.211'] and hl7:templateId[@root = '1.2.840.10008.9.7']]/hl7:templateId[@root = '1.2.250.1.213.1.1.2.211']" id="d823743e3062-false-d898206e0">
        <extends rule="II"/>
...
Item: (FR-DICOM-Demande-examen)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.211'] and hl7:templateId[@root = '1.2.840.10008.9.7']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.211'] and hl7:templateId[@root = '1.2.840.10008.9.7']]/hl7:templateId[@root = '1.2.840.10008.9.7']" id="d823743e3068-false-d898220e0">
        <extends rule="II"/>
        <assert role="error" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--CR-IMG-?id=1.2.250.1.213.1.1.2.211" test="empty(@xsi:type) or resolve-QName(@xsi:type, .) = QName('urn:hl7-org:v3', 'II')">(FR-DICOM-Demande-examen): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
...
Item: (FR-DICOM-Demande-examen)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.211'] and hl7:templateId[@root = '1.2.840.10008.9.7']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.211'] and hl7:templateId[@root = '1.2.840.10008.9.7']]/hl7:id" id="d823743e3074-false-d898233e0">
        <extends rule="II"/>
        <assert role="error" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--CR-IMG-?id=1.2.250.1.213.1.1.2.211" test="empty(@xsi:type) or resolve-QName(@xsi:type, .) = QName('urn:hl7-org:v3', 'II')">(FR-DICOM-Demande-examen): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
    </rule>
   <!--
...
Item: (FR-DICOM-Demande-examen)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.211'] and hl7:templateId[@root = '1.2.840.10008.9.7']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.211'] and hl7:templateId[@root = '1.2.840.10008.9.7']]/hl7:title" id="d823743e3086-false-d898273e0">
        <extends rule="ST"/>
...
Item: (FR-DICOM-Demande-examen)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.211'] and hl7:templateId[@root = '1.2.840.10008.9.7']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.211'] and hl7:templateId[@root = '1.2.840.10008.9.7']]/hl7:text" id="d823743e3090-false-d898282e0">
        <extends rule="ED"/>
