...
Item: (FR-DICOM-Complications)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.214'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.22.2.37']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.214'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.22.2.37']]" id="d823743e3161-false-d899524e0">
...
Item: (FR-DICOM-Complications)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.214'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.22.2.37']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.214'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.22.2.37']]/hl7:templateId[@root = '1.2.250.1.213.1.1.2.214']" id="d823743e3167-false-d899589e0">
        <extends rule="II"/>
...
Item: (FR-DICOM-Complications)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.214'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.22.2.37']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.214'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.22.2.37']]/hl7:templateId[@root = '2.16.840.1.113883.10.20.22.2.37']" id="d823743e3173-false-d899603e0">
        <extends rule="II"/>
        <assert role="error" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--CR-IMG-?id=1.2.250.1.213.1.1.2.214" test="empty(@xsi:type) or resolve-QName(@xsi:type, .) = QName('urn:hl7-org:v3', 'II')">(FR-DICOM-Complications): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
...
Item: (FR-DICOM-Complications)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.214'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.22.2.37']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.214'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.22.2.37']]/hl7:id" id="d823743e3179-false-d899616e0">
        <extends rule="II"/>
        <assert role="error" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--CR-IMG-?id=1.2.250.1.213.1.1.2.214" test="empty(@xsi:type) or resolve-QName(@xsi:type, .) = QName('urn:hl7-org:v3', 'II')">(FR-DICOM-Complications): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
    </rule>
   <!--
...
Item: (FR-DICOM-Complications)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.214'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.22.2.37']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.214'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.22.2.37']]/hl7:title" id="d823743e3191-false-d899656e0">
        <extends rule="ST"/>
...
Item: (FR-DICOM-Complications)
-->
    <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.214'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.22.2.37']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.214'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.22.2.37']]/hl7:text" id="d823743e3195-false-d899665e0">
