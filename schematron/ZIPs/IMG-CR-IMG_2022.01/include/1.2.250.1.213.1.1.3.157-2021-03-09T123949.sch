...
Item: (FR-DICOM-SOP-instance-observation)
-->
    <rule fpi="RULC-1" context="*[hl7:observation[hl7:templateId[@root = '1.2.250.1.213.1.1.3.157'] and hl7:templateId[@root = '1.2.840.10008.9.18']]]/hl7:observation[hl7:templateId[@root = '1.2.250.1.213.1.1.3.157'] and hl7:templateId[@root = '1.2.840.10008.9.18']]/hl7:code[concat(@code, @codeSystem) = doc('include/voc-1.2.250.1.213.1.1.5.689-DYNAMIC.xml')//valueSet[1]/conceptList/concept/concat(@code, @codeSystem)]" id="d823743e4211-false-d900727e0">
        <extends rule="CD"/>
