...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    <title>Scenario: TR2 - Initialb (1.2.250.1.213.1.1.1.29.99.4.2)</title>
   ...
   <!-- Include the project schematrons related to scenario TR2 -->

<!-- LDL-SES -->
    <pattern>
        <title>LDL-SES</title>
        <rule context="/">
            <assert role="warning" test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.29']]" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--IDL_SORTIE-?id=1.2.250.1.213.1.1.1.29">descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.29']]: Instance is expected to have the following element: %%2</assert>
        </rule>
    </pattern>
    <include href="include/1.2.250.1.213.1.1.1.29-2020-04-29T164726.sch"/>
    <include href="include/1.2.250.1.213.1.1.1.29-2020-04-29T164726-closed.sch"/>


   <!-- Create phases for more targeted validation on large instances -->
    <phase id="AllExceptClosed">
        <active pattern="template-1.2.250.1.213.1.1.1.29-2020-04-29T164726"/>
        <active pattern="template-1.2.250.1.213.1.1.3.48.8-2021-07-12T145406"/>
    </phase>
    <phase id="LDL-SES">
        <active pattern="template-1.2.250.1.213.1.1.1.29-2020-04-29T164726"/>
    </phase>
    <phase id="LDL-SES-closed">
        <active pattern="template-1.2.250.1.213.1.1.1.29-2020-04-29T164726-closed"/>
    </phase>
    <phase id="FR-Recherche-de-micro-organismes">
        <active pattern="template-1.2.250.1.213.1.1.3.48.8-2021-07-12T145406"/>
    </phase>
    <phase id="FR-Recherche-de-micro-organismes-closed">
        <active pattern="template-1.2.250.1.213.1.1.3.48.8-2021-07-12T145406-closed"/>
    </phase>

   <!-- Include schematrons from templates with explicit * or ** context (but no representing templates), only those used in scenario template -->

<!-- FR-Recherche-de-micro-organismes -->
    <include href="include/1.2.250.1.213.1.1.3.48.8-2021-07-12T145406.sch"/>
    <include href="include/1.2.250.1.213.1.1.3.48.8-2021-07-12T145406-closed.sch"/>
</schema>