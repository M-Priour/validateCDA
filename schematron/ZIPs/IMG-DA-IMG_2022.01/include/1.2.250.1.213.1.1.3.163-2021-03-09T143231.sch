...
Item: (FR-DICOM-Objectifs-de-reference)
-->
    <rule fpi="RULC-1" context="*[hl7:observation[hl7:templateId[@root = '1.2.250.1.213.1.1.3.163']]]/hl7:observation[hl7:templateId[@root = '1.2.250.1.213.1.1.3.163']]" id="d958630e3089-false-d1014597e0">
        ...
        <assert role="error" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--IMG-DA-IMG_2022-?id=1.2.250.1.213.1.1.3.163" test="count(hl7:value) &gt;= 1">(FR-DICOM-Objectifs-de-reference): element hl7:value is required [min 1x].</assert>
        <assert role="error" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--IMG-DA-IMG_2022-?id=1.2.250.1.213.1.1.3.163" test="count(hl7:value) &lt;= 1">(FR-DICOM-Objectifs-de-reference): element hl7:value appears too often [max 1x].</assert>
    </rule>
   <!--
Template derived rules for ID: 1.2.250.1.213.1.1.3.163
...
Item: (FR-DICOM-Objectifs-de-reference)
-->
    <rule fpi="RULC-1" context="*[hl7:observation[hl7:templateId[@root = '1.2.250.1.213.1.1.3.163']]]/hl7:observation[hl7:templateId[@root = '1.2.250.1.213.1.1.3.163']]/hl7:templateId[@root = '1.2.250.1.213.1.1.3.163']" id="d958630e3093-false-d1014650e0">
        <extends rule="II"/>
...
Item: (FR-DICOM-Objectifs-de-reference)
-->
    <rule fpi="RULC-1" context="*[hl7:observation[hl7:templateId[@root = '1.2.250.1.213.1.1.3.163']]]/hl7:observation[hl7:templateId[@root = '1.2.250.1.213.1.1.3.163']]/hl7:code[(@code = 'ASSERTION' and @codeSystem = '2.16.840.1.113883.5.4')]" id="d958630e3099-false-d1014664e0">
        <extends rule="CD"/>
...
Item: (FR-DICOM-Objectifs-de-reference)
-->
    <rule fpi="RULC-1" context="*[hl7:observation[hl7:templateId[@root = '1.2.250.1.213.1.1.3.163']]]/hl7:observation[hl7:templateId[@root = '1.2.250.1.213.1.1.3.163']]/hl7:value" id="d958630e3108-false-d1014694e0">
        <extends rule="ANY"/>
    </rule>
</pattern>