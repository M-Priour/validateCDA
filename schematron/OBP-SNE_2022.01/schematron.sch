...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" queryBinding="xslt2">
    <title>Scenario: OBP-SNE - Initial (1.2.250.1.213.1.1.1.12.3.4.2)</title>
   ...
   <!-- Include the project schematrons related to scenario OBP-SNE -->

<!-- OBP-SNE -->
    <pattern>
        <title>OBP-SNE</title>
        <rule context="/">
            <assert role="warning" test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.12.3']]" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--ModeleDeLaSyntheseSalleDeNaissanceEnfantOBPSNE-?id=1.2.250.1.213.1.1.1.12.3">descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.12.3']]: Instance is expected to have the following element: %%2</assert>
        </rule>
    </pattern>
    <include href="include/1.2.250.1.213.1.1.1.12.3-2020-08-18T110231.sch"/>
    <include href="include/1.2.250.1.213.1.1.1.12.3-2020-08-18T110231-closed.sch"/>
