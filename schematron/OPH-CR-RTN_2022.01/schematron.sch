...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Scenario: OPH-CR-RTN - Initial (1.2.250.1.213.1.1.1.18.4.2)</title>
   ...
   <!-- Include the project schematrons related to scenario OPH-CR-RTN -->
   <!-- OPH-CR-RTN_2022.01 -->
   <pattern>
      <title>OPH-CR-RTN_2022.01</title>
      <rule context="/">
         <assert role="warning" test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.18']]" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--OPH-CR-RTN-?id=1.2.250.1.213.1.1.1.18">descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.18']]: Instance is expected to have the following element: %%2</assert>
      </rule>
   </pattern>
   <include href="include/1.2.250.1.213.1.1.1.18-2021-11-03T151903.sch"/>
   <include href="include/1.2.250.1.213.1.1.1.18-2021-11-03T151903-closed.sch"/>
