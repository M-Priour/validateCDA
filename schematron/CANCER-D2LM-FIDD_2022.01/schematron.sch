...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" queryBinding="xslt2">
   <title>Scenario: CANCER-D2LM-FIDD - Initial (1.2.250.1.213.1.1.1.28.4.7)</title>
   ...
   <!-- Include the project schematrons related to scenario CANCER-D2LM-FIDD -->
   <!-- CANCER-D2LM-FIDD -->
   <pattern>
      <title>CANCER-D2LM-FIDD</title>
      <rule context="/">
         <assert role="warning" test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.28']]" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--ASIP-D2LM-FIDD-?id=1.2.250.1.213.1.1.1.28">descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.28']]: Instance is expected to have the following element: %%2</assert>
      </rule>
   </pattern>
   <include href="include/1.2.250.1.213.1.1.1.28-2017-12-28T133303.sch"/>
   <include href="include/1.2.250.1.213.1.1.1.28-2017-12-28T133303-closed.sch"/>
