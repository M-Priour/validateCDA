...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    <title>Scenario: IMG-DA-IMG - Initial (1.2.250.1.213.1.1.1.47.2022.4.2)</title>
   ...
   <!-- Include the project schematrons related to scenario IMG-DA-IMG -->

<!-- DemandeActeImagerie -->
    <pattern>
        <title>DemandeActeImagerie</title>
        <rule context="/">
            <assert role="warning" test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1']]" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--IMG-DA-IMG_2022-?id=1.2.250.1.213.1.1.1.47">descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1']]: Instance is expected to have the following element: %%2</assert>
        </rule>
    </pattern>
    <include href="include/1.2.250.1.213.1.1.1.47-2022-01-12T113414.sch"/>
    <include href="include/1.2.250.1.213.1.1.1.47-2022-01-12T113414-closed.sch"/>


   <!-- Create phases for more targeted validation on large instances -->
    <phase id="AllExceptClosed">
        <active pattern="template-1.2.250.1.213.1.1.1.47-2022-01-12T113414"/>
    ...
    <phase id="DemandeActeImagerie">
        <active pattern="template-1.2.250.1.213.1.1.1.47-2022-01-12T113414"/>
    </phase>
    <phase id="DemandeActeImagerie-closed">
        <active pattern="template-1.2.250.1.213.1.1.1.47-2022-01-12T113414-closed"/>
    </phase>
