...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" queryBinding="xslt2">
    <title>Scenario: CR-GM - Initial (1.2.250.1.213.1.1.1.32.4.2)</title>
   ...
   <!-- Include the project schematrons related to scenario CR-GM -->

<!-- CR-GM -->
    <pattern>
        <title>CR-GM</title>
        <rule context="/">
            <assert role="warning" test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.32']]" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--CR-GM-?id=1.2.250.1.213.1.1.1.32">descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.32']]: Instance is expected to have the following element: %%2</assert>
        </rule>
    </pattern>
    <include href="include/1.2.250.1.213.1.1.1.32-2020-08-03T123530.sch"/>
    <include href="include/1.2.250.1.213.1.1.1.32-2020-08-03T123530-closed.sch"/>
