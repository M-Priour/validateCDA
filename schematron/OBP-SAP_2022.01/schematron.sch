...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" queryBinding="xslt2">
   <title>Scenario: OBP-SAP - Initial (1.2.250.1.213.1.1.1.12.1.4.2)</title>
   ...
   <!-- Include the project schematrons related to scenario OBP-SAP -->
   <!-- OBP-SAP -->
   <pattern>
      <title>OBP-SAP</title>
      <rule context="/">
         <assert role="warning" test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.12.1']]" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--ObstetriqueEtPerinataliteOBP-?id=1.2.250.1.213.1.1.1.12.1">descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.12.1']]: Instance is expected to have the following element: %%2</assert>
      </rule>
   </pattern>
   <include href="include/1.2.250.1.213.1.1.1.12.1-2020-08-14T121603.sch"/>
   <include href="include/1.2.250.1.213.1.1.1.12.1-2020-08-14T121603-closed.sch"/>
