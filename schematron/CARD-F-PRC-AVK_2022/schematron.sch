...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Scenario: FPRC-AVK - Initial (1.2.250.1.213.1.1.1.2.1.1.2021.4.2)</title>
   ...
   <!-- Include the project schematrons related to scenario FPRC-AVK -->
   <!-- CARD-F-PRC-AVK -->
   <pattern>
      <title>CARD-F-PRC-AVK</title>
      <rule context="/">
         <assert role="warning" test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.2'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.2.1.1']]" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--F-PRC_AVK-?id=1.2.250.1.213.1.1.1.2.1.1">descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.2'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.2.1.1']]: Instance is expected to have the following element: %%2</assert>
      </rule>
   </pattern>
   <include href="include/1.2.250.1.213.1.1.1.2.1.1-2021-12-03T160316.sch"/>
   <include href="include/1.2.250.1.213.1.1.1.2.1.1-2021-12-03T160316-closed.sch"/>
