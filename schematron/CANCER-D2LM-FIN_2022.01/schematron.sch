...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    <title>Scenario: D2LM-FIN - D2LM-FIN (1.2.250.1.213.1.1.1.27.4.2)</title>
   ...
   <!-- Include the project schematrons related to scenario D2LM-FIN -->

<!-- CANCER-D2LM-FIN -->
    <pattern>
        <title>CANCER-D2LM-FIN</title>
        <rule context="/">
            <assert role="warning" test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.27']]" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--ASIP-D2LM-FIN-?id=1.2.250.1.213.1.1.1.27">descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.27']]: Instance is expected to have the following element: %%2</assert>
        </rule>
    </pattern>
    <include href="include/1.2.250.1.213.1.1.1.27-2017-12-27T152311.sch"/>
    <include href="include/1.2.250.1.213.1.1.1.27-2017-12-27T152311-closed.sch"/>
