...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
    <title>Scenario: V1 - Initial (1.2.250.1.213.1.1.1.39.999.1.4.2)</title>
   ...
   <!-- Add extra namespaces -->
    ...
    <ns uri="urn:ihe:pharm" prefix="XXX"/>
   ...
   <!-- Include the project schematrons related to scenario V1 -->

<!-- eP-MED -->
    <pattern>
        <title>eP-MED</title>
        <rule context="/">
            <assert role="warning" test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.9.1.1.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.39']]" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--ePMED-?id=1.2.250.1.213.1.1.1.39">descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.9.1.1.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.5.3.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.39']]: Instance is expected to have the following element: %%2</assert>
        </rule>
    </pattern>
    <include href="include/1.2.250.1.213.1.1.1.39-2020-01-22T174612.sch"/>
    <include href="include/1.2.250.1.213.1.1.1.39-2020-01-22T174612-closed.sch"/>


   <!-- Create phases for more targeted validation on large instances -->
    <phase id="AllExceptClosed">
        <active pattern="template-1.2.250.1.213.1.1.1.39-2020-01-22T174612"/>
        <active pattern="template-1.2.250.1.213.1.1.2.223-2021-06-15T144633"/>
    </phase>
    <phase id="eP-MED">
        <active pattern="template-1.2.250.1.213.1.1.1.39-2020-01-22T174612"/>
    </phase>
    <phase id="eP-MED-closed">
        <active pattern="template-1.2.250.1.213.1.1.1.39-2020-01-22T174612-closed"/>
    </phase>
    <phase id="FR-Code-a-barres">
        <active pattern="template-1.2.250.1.213.1.1.2.223-2021-06-15T144633"/>
    </phase>
...
<!-- FR-Code-a-barres -->
    <include href="include/1.2.250.1.213.1.1.2.223-2021-06-15T144633.sch"/>
</schema>