...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" queryBinding="xslt2">
   <title>Scenario: TLM-CR -  (1.3.6.1.4.1.19376.1.2.20.2021.4.2)</title>
   ...
   <!-- Include the project schematrons related to scenario TLM-CR -->
   <!-- TLM-CR_2022.01 -->
   <pattern>
      <title>TLM-CR_2022.01</title>
      <rule context="/">
         <assert role="warning" test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.2.20']]" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--TLM-CR_2021.01-?id=1.3.6.1.4.1.19376.1.2.20">descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.3.6.1.4.1.19376.1.2.20']]: Instance is expected to have the following element: %%2</assert>
      </rule>
   </pattern>
   <include href="include/1.3.6.1.4.1.19376.1.2.20-2021-10-25T151637.sch"/>
   <include href="include/1.3.6.1.4.1.19376.1.2.20-2021-10-25T151637-closed.sch"/>
