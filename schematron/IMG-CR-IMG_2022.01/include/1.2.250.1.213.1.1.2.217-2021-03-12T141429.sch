...
Item: (FR-DICOM-Object-Catalog)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.217'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.6.1.1']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.217'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.6.1.1']]" id="d152e19882-false-d88381e0">
...
Item: (FR-DICOM-Object-Catalog)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.217'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.6.1.1']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.217'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.6.1.1']]/hl7:templateId[@root = '1.2.250.1.213.1.1.2.217']" id="d152e19890-false-d88497e0">
      <extends rule="II"/>
...
Item: (FR-DICOM-Object-Catalog)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.217'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.6.1.1']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.217'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.6.1.1']]/hl7:templateId[@root = '2.16.840.1.113883.10.20.6.1.1']" id="d152e19902-false-d88515e0">
      <extends rule="II"/>
      <assert role="error" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--CR-IMG-?id=1.2.250.1.213.1.1.2.217" test="empty(@xsi:type) or resolve-QName(@xsi:type, .) = QName('urn:hl7-org:v3', 'II')">(FR-DICOM-Object-Catalog): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
...
Item: (FR-DICOM-Object-Catalog)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.217'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.6.1.1']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.217'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.6.1.1']]/hl7:id" id="d152e19915-false-d88533e0">
      <extends rule="II"/>
      <assert role="error" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--CR-IMG-?id=1.2.250.1.213.1.1.2.217" test="empty(@xsi:type) or resolve-QName(@xsi:type, .) = QName('urn:hl7-org:v3', 'II')">(FR-DICOM-Object-Catalog): If an @xsi:type instruction is present it SHALL be valued "{urn:hl7-org:v3}:II". Found "{<value-of select="namespace-uri-from-QName(resolve-QName(@xsi:type,.))"/>}:<value-of select="local-name-from-QName(resolve-QName(@xsi:type,.))"/>"</assert>
   </rule>
   <!--
...
Item: (FR-DICOM-Object-Catalog)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.217'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.6.1.1']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.217'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.6.1.1']]/hl7:title[not(@nullFlavor)]" id="d152e19928-false-d88592e0">
      <extends rule="ST"/>
...
Item: (FR-DICOM-Object-Catalog)
-->
   <rule fpi="RULC-1" context="*[hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.217'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.6.1.1']]]/hl7:section[hl7:templateId[@root = '1.2.250.1.213.1.1.2.217'] and hl7:templateId[@root = '2.16.840.1.113883.10.20.6.1.1']]/hl7:text[not(@nullFlavor)]" id="d152e19930-false-d88604e0">
