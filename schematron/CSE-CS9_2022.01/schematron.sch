...
<schema xmlns="http://purl.oclc.org/dsdl/schematron" xmlns:local="http://art-decor.org/functions" xmlns:hl7="urn:hl7-org:v3" xmlns:sch="http://purl.oclc.org/dsdl/schematron" queryBinding="xslt2">
   <title>Scenario: V1 - Initial (1.2.250.1.213.1.1.1.5.2.4.2)</title>
   ...
   <pattern>
      <title>CSE-CS9</title>
      <rule context="/">
         <assert role="warning" test="descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.5'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.5.2']]" see="https://o3sis.esante.gouv.fr/art-decor/decor-templates--CSE-CS9-?id=1.2.250.1.213.1.1.1.5.2">descendant-or-self::hl7:ClinicalDocument[hl7:templateId[@root = '2.16.840.1.113883.2.8.2.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.1'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.5'] and hl7:templateId[@root = '1.2.250.1.213.1.1.1.5.2']]: Instance is expected to have the following element: %%2</assert>
      </rule>
   </pattern>
   <include href="include/1.2.250.1.213.1.1.1.5.2-2020-07-07T134828.sch"/>
   <include href="include/1.2.250.1.213.1.1.1.5.2-2020-07-07T134828-closed.sch"/>
